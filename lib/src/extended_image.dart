...
class ExtendedImage extends StatefulWidget {
  ExtendedImage({
    ...
    this.layoutInsets = EdgeInsets.zero,
        ...
        constraints =
            (width != null || height != null) ? constraints?.tighten(width: width, height: height) ?? BoxConstraints.tightFor(width: width, height: height) : constraints,
        super(key: key);
...
class _ExtendedImageState extends State<ExtendedImage> with ExtendedImageState, WidgetsBindingObserver {
  ...
  void _resolveImage([bool rebuild = false]) {
    ...
    final ImageStream newStream =
        provider.resolve(createLocalImageConfiguration(context, size: widget.width != null && widget.height != null ? Size(widget.width!, widget.height!) : null));
